...
# otevření souboru 1
with open('adresy_rakouske_ms_Urfahr-Umgebung.csv', encoding='utf-8') as vstup:
...
with open("AT_povedene_Urfahr.csv", "w", encoding="utf-8") as vystup:
    vystup.writelines(povedene)

with open("AT_nepovedene_Urfahr.csv", "w", encoding="utf-8") as soubor:
